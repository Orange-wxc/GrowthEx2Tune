...
# from parl.algorithms import torch
import torch
...
class DDPG(Algorithm):
    ...
    def critic_learn(self, obs, action, reward, next_obs, terminal):
        ...
        # mask = [0 if x else 1 for x in terminal]
        # mask = (mask)
        # next_value = batch_rewards
        # self.error = layers.abs(current_value-next_value)
